      ...
      <div className="container px-4 py-8 md:px-6 lg:py-12">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 xl:grid-cols-3">
          <div className="flex flex-col overflow-hidden rounded-lg border  border-green-950 bg-white shadow-sm  dark:border-gray-800 dark:bg-gray-950">
            ...
            <div className="p-4">
              <Link
                className="inline-flex w-full items-center justify-center rounded-b-md bg-gray-900 px-4 py-2 text-md font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50"
          ...
          <div className="flex flex-col overflow-hidden rounded-lg border  border-green-900 bg-white shadow-sm  dark:border-gray-800 dark:bg-gray-950">
            ...
            <div className="p-4">
              <Link
                className="inline-flex w-full items-center justify-center rounded-b-md bg-gray-900 px-4 py-2 text-md font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300"
                href="https://hostinger.com?REFERRALCODE=1EMMANUELMA82"
              >
                Choose Plan
              </Link>
