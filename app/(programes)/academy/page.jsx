...
export default function Academy() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="bg-gray-100 py-0 md:py-5  lg:py-8 dark:bg-gray-800">
        {" "}
        {/* here for the img me*/}
        <div className="container mx-auto px-4">
      ...
      <section className="bg-gray-100 py-8 md:py-5 lg:py-8 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="grid gap-6 md:gap-12 lg:grid-cols-2 xl:gap-16">
            {/* Course 02 */}
            <div className="flex flex-col justify-center space-y-4">
      ...
      <section className="bg-gray-100 py-1 md:py-5 lg:py-8 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="grid gap-6 md:gap-12 lg:grid-cols-2 xl:gap-16">
            {/* Course 03 */}
            <div className="flex flex-col justify-center space-y-4">
