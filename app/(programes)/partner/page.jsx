        ...
        <div className="container space-y-12 px-4 md:px-6">
          ...
          <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
            <div className="grid gap-1">
              <h3 className="text-2xl font-bold">Increased Revenue</h3>
            ...
            <div className="grid gap-1">
              <h3 className="text-2xl font-bold">Exclusive Discounts</h3>
              <p className="text-lg text-gray-500 dark:text-gray-400">
            ...
            <div className="grid gap-1">
              <h3 className="text-2xl font-bold">Co-Marketing Opportunities</h3>
              <p className="text-lg text-gray-500 dark:text-gray-400">
            ...
            <div className="grid gap-1">
              <h3 className="text-2xl font-bold">Access to Resources</h3>
              <p className="text-lg text-gray-500 dark:text-gray-400">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
        <div className="container space-y-12 px-4 md:px-6">
          ...
          <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
            ...
            <div className="grid gap-1">
              <h3 className="text-2xl font-bold">Affiliate</h3>
              <p className="text-lg text-gray-500 dark:text-gray-400">
            ...
            <div className="grid gap-1">
              <h3 className="text-2xl font-bold">Strategic Partner</h3>
              <p className="text-lg text-gray-500 dark:text-gray-400">
